    ...
    <>
      <style>{`
        ...
        *{margin:0;padding:0;box-sizing:border-box}
        ...
        .nav-cta{font-size:14px;color:var(--black);text-decoration:none;transition:opacity 0.2s}
        ...
        .h-text{font-family:'Anton',sans-serif;font-size:clamp(70px,13vw,196px);line-height:0.92;color:var(--white);text-transform:uppercase;letter-spacing:-0.01em;display:block;opacity:0;transform:translateY(55px);animation:su 0.85s cubic-bezier(0.16,1,0.3,1) forwards}
        ...
        .hero-link{font-size:13px;font-weight:500;letter-spacing:0.06em;text-transform:uppercase;color:var(--white);text-decoration:none;border-bottom:1px solid rgba(255,255,255,0.28);padding-bottom:2px;transition:border-color 0.25s}
        ...
        #clients{padding:3rem 2.5rem;border-bottom:1px solid rgba(0,0,0,0.08);display:flex;align-items:center;gap:3.5rem}
        .cl-label{font-size:11px;letter-spacing:0.16em;text-transform:uppercase;color:var(--mid);white-space:nowrap}
        .cl-sep{width:1px;height:22px;background:rgba(0,0,0,0.1);flex-shrink:0}
        .cl-list{display:flex;gap:3rem;flex-wrap:wrap;align-items:center}
        .cl-name{font-size:14px;font-weight:500;color:rgba(0,0,0,0.18);transition:color 0.22s;cursor:default}
        .cl-name:hover{color:var(--black)}
        #work{}
        ...
        .v-card{background:var(--gray);padding:3rem 2.4rem;transition:background 0.28s}
      ...
      <div id="clients">
        <span className="cl-label">Clients</span>
        <div className="cl-sep"></div>
        <div className="cl-list">
          {['BCG Group','Harcourts','Ray White','Allgot','Victoria Sushi'].map(c => (
            <span key={c} className="cl-name">{c}</span>
          ))}
        </div>
      </div>
      ...
      <section id="verticals">
        ...
        <div className="v-grid">
          {[{handle:'@viralx_nz',name:'Agency',desc:'Strategy, creative direction, and full-service marketing.'},{handle:'@viralx_productions',name:'Productions',desc:'Commercial video for real estate and business.'},{handle:'@viralx_hospitality',name:'Hospitality',desc:'F&B content agency turning everyday restaurants into viral hits.'}].map(v => (
